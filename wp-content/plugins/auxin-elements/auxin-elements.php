...
if( is_admin() ||
    ...
    ! file_exists( get_template_directory() . '/auxin-content/init/dependency.php' ) || ( !empty( $GLOBALS['pagenow'] ) && in_array($GLOBALS['pagenow'], array('wp-login.php', 'wp-register.php') ))
){
